...
const PUZZLES = [
      ...
      { prompt: "Which 3 numbers give the same answer when added or multiplied?", answer: "1, 2, 3" },
      { prompt: "Roman numeral puzzle: Convert XLIV", answer: "44" },
      { prompt: "Which is larger: 2³ × 3² or 5³?", answer: "5³" },
      { prompt: "If it takes 5 machines 5 minutes to make 5 gadgets, how long will 100 machines take to make 100 gadgets?", answer: "5 minutes" },
      ...
      { prompt: "Unscramble: TNOAP", answer: "Plant" },
      { prompt: "A palindrome word for a female parent", answer: "Mom" },
      { prompt: "Change one letter in 'COLD' to make something you eat.", answer: "Food" },
      ...
      { prompt: "What is Superman’s Kryptonian name?", answer: "Kal-El" },
      { prompt: "In Star Wars, what is Han Solo’s ship called?", answer: "Millennium Falcon" },
      ...
      { prompt: "What 7-letter word is spelled the same forward and backward?", answer: "Racecar" },
      { prompt: "How many 0’s in one million?", answer: "6" },
      { prompt: "Which letter is also a question?", answer: "Y" },
      { prompt: "Which two keys can’t open any door?", answer: "Monkey, Donkey" },
      ...
      { prompt: "A man gave one son 10 cents and another 15 cents. What time was it?", answer: "Quarter to Two" },
      { prompt: "I have keys but no locks, space but no room.", answer: "Keyboard" },
      { prompt: "The one who makes me, tells me not. The one who takes me, knows me not.", answer: "Counterfeit money" },
