...
const PUZZLES = [
    ...
    { prompt: "The more you share me, the less I become.", answer: "Secret" },
    { prompt: "I’m tall when I’m young and short when I’m old.", answer: "Candle" },
    { prompt: "The more of me you take, the more you leave behind.", answer: "Footsteps" },
    { prompt: "I have no mouth but can speak, no ears but can hear.", answer: "Echo" },
    { prompt: "What begins with T, ends with T, and is filled with T?", answer: "Teapot" },
    { prompt: "What belongs to you but is used by everyone else?", answer: "Name" },
    { prompt: "I’m full of holes but I can hold water.", answer: "Sponge" },
    { prompt: "If two’s company and three’s a crowd, what are four and five?", answer: "Nine" },
    { prompt: "Which weighs more, a kilo of cotton or a kilo of iron?", answer: "Equal" },
    { prompt: "What gets wetter the more it dries?", answer: "Towel" },
    { prompt: "What has a face and hands but no arms or legs?", answer: "Clock" },
    { prompt: "The one who makes me, sells me. The one who buys me, never uses me.", answer: "Coffin" },
    { prompt: "I fly without wings, I cry without eyes.", answer: "Cloud" },
    { prompt: "If you drop me, I’m sure to crack. But give me a smile, and I’ll smile back.", answer: "Mirror" },
    { prompt: "What runs but never walks?", answer: "River" },
    { prompt: "Which month has 28 days?", answer: "All" },
    { prompt: "What is 15 + 27?", answer: "42" },
    { prompt: "Half of 100", answer: "50" },
    { prompt: "81 divided by 9", answer: "9" },
    { prompt: "If today is Monday, what day will it be in 3 days?", answer: "Thursday" },
    { prompt: "Next number: 2, 4, 8, 16, ?", answer: "32" },
    { prompt: "How many sides does a hexagon have?", answer: "6" },
    { prompt: "Convert Roman numeral XV into a number", answer: "15" },
    { prompt: "What is 7 squared?", answer: "49" },
    { prompt: "Add the first 5 odd numbers", answer: "25" },
    { prompt: "If you double 12, subtract 4, what do you get?", answer: "20" },
    ...
    { prompt: "Which continent is Egypt in?", answer: "Africa" },
    { prompt: "Who wrote “Romeo and Juliet”?", answer: "Shakespeare" },
    { prompt: "The fastest land animal", answer: "Cheetah" },
    { prompt: "Primary colors are red, blue and…?", answer: "Yellow" },
    { prompt: "National animal of India", answer: "Tiger" },
    ...
    { prompt: "Synonym of 'Fast'", answer: "Quick" },
    { prompt: "'Happy' is to 'Sad' as 'Big' is to…", answer: "Small" },
    { prompt: "Find the hidden word in 'cANDle'", answer: "And" },
    { prompt: "Complete: Sun rises in the…", answer: "East" },
    { prompt: "Word starting with 'D' and ending with 'G' (hint: pet)", answer: "Dog" },
    { prompt: "How many hours in a day?", answer: "24" },
    { prompt: "How many days in a leap year?", answer: "366" },
    { prompt: "How many minutes in an hour?", answer: "60" },
    { prompt: "How many letters in the English alphabet?", answer: "26" },
    { prompt: "What is 100 ÷ 25?", answer: "4" },
    { prompt: "Multiply 9 × 9", answer: "81" },
    { prompt: "What is 1 less than 100?", answer: "99" },
    { prompt: "What is 10% of 200?", answer: "20" },
    { prompt: "Double of 13", answer: "26" },
    { prompt: "3rd prime number", answer: "5" },
    { prompt: "Who is Harry Potter’s best friend?", answer: "Ron" },
    { prompt: "In “Avengers,” who says “I am Iron Man”?", answer: "Tony" },
    { prompt: "What color is Pikachu?", answer: "Yellow" },
    { prompt: "Superhero from Gotham City", answer: "Batman" },
    { prompt: "Elsa sings which song in Frozen?", answer: "Let It Go" },
    { prompt: "First name of Mr. Bean", answer: "Rowan" },
    { prompt: "Which company makes iPhones?", answer: "Apple" },
    { prompt: "Famous mouse by Disney", answer: "Mickey" },
    { prompt: "Famous plumber in Nintendo", answer: "Mario" },
    { prompt: "What’s the opposite of Jedi?", answer: "Sith" },
    { prompt: "Count the letters in “UNLOCK”", answer: "6" },
    { prompt: "Spell the word backwards: 'GAME'", answer: "EMAG" },
    { prompt: "How many vowels in 'ESCAPE'?", answer: "3" },
    { prompt: "First letter of the alphabet", answer: "A" },
    { prompt: "Last letter of 'Puzzle'", answer: "E" },
    { prompt: "Middle letter of 'DOOR'", answer: "O" },
    { prompt: "Which letter comes after C?", answer: "D" },
    { prompt: "Which number looks like an egg?", answer: "0" },
    { prompt: "Which number looks like a snake?", answer: "2" },
    { prompt: "Which letter looks like a circle?", answer: "O" },
    { prompt: "First man on the moon", answer: "Armstrong" },
    { prompt: "Longest river in the world", answer: "Nile" },
    { prompt: "National sport of Japan", answer: "Sumo" },
    { prompt: "Smallest country in the world", answer: "Vatican" },
    { prompt: "Instrument with black and white keys", answer: "Piano" },
    { prompt: "Shape with 4 equal sides", answer: "Square" },
    { prompt: "Which animal is known as 'Ship of the Desert'?", answer: "Camel" },
    { prompt: "Opposite of North", answer: "South" },
    { prompt: "First month of the year", answer: "January" },
    { prompt: "Last day of the week (commonly)", answer: "Sunday" },
    { prompt: "How many colors in a rainbow?", answer: "7" },
    { prompt: "The color of grass", answer: "Green" },
    { prompt: "Sound a dog makes", answer: "Bark" },
    { prompt: "How many legs does a spider have?", answer: "8" },
    { prompt: "Opposite of day", answer: "Night" },
    { prompt: "Complete: Stars and ____", answer: "Stripes" },
    { prompt: "Animal that says “Moo”", answer: "Cow" },
    { prompt: "A triangle has how many sides?", answer: "3" },
    { prompt: "A baby cat is called?", answer: "Kitten" },
    { prompt: "Which planet do we live on?", answer: "Earth" },
];
